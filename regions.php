...
<body>
	...
	<section class="annonces">
		<div class="container">
			<h2><?php echo $_GET["region"] ?></h2>
	
			<?php //-----------extraire l'information de BD
			$res = mysql_query("SELECT titre, description, prix, dateAnnonce, nomVille FROM Annonces NATURAL JOIN Utilisateurs NATURAL JOIN Villes NATURAL JOIN Regions WHERE nomRegion = '".$_GET["region"]."'");
